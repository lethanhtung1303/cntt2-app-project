...
CREATE TABLE TDT_LECTURER_TYPE (
    ...
    UPDATED_AT DATE DEFAULT NULL,
    UPDATE_BY VARCHAR2(255 CHAR) DEFAULT NULL,
    CONSTRAINT PK_loai_giang_vien PRIMARY KEY (TYPE_ID)
);
...
CREATE TABLE TDT_LECTURER (
	...
	CONSTRAINT FK_giang_vien_loai_giang_vien FOREIGN KEY (CLASSIFICATION_LECTURERS) REFERENCES TDT_LECTURER_TYPE(TYPE_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE TDT_qua_trinh_dao_tao (
	...
	CONSTRAINT FK_qua_trinh_dao_tao_loai_tot_nghiep FOREIGN KEY (loai_tot_nghiep_id) REFERENCES TDT_GRADUATION_TYPE(ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE TDT_diem_hai_long (
	...
	CONSTRAINT FK_diem_hai_long_giang_vien FOREIGN KEY (giang_vien_id) REFERENCES TDT_LECTURER(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_diem_hai_long_mon_hoc FOREIGN KEY (ma_mon) REFERENCES TDT_SUBJECT(SUBJECT_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
