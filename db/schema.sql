...
CREATE TABLE TDT_mon_hoc (
	...
	CONSTRAINT FK_mon_hoc_loai_mon FOREIGN KEY (ma_loai) REFERENCES TDT_SUBJECT_TYPE(TYPE_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE TDT_CERTIFICATE(
    ...
    CONSTRAINT CONSTRAINT_FK_CERTIFICATE_LECTURER FOREIGN KEY (LECTURER_ID) REFERENCES TDT_giang_vien(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
