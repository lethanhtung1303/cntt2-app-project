...
CREATE TABLE TDT_qua_trinh_dao_tao (
	...
	CONSTRAINT FK_qua_trinh_dao_tao_giang_vien FOREIGN KEY (giang_vien_id) REFERENCES TDT_LECTURER(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_qua_trinh_dao_tao_trinh_do FOREIGN KEY (trinh_do_id) REFERENCES TDT_DEGREE(id) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE TDT_TRAINING_LANGUAGE (
    ...
    CONSTRAINT FK_TRAINING_LANGUAGE_TRAINING_PROCESS FOREIGN KEY (TRAINING_PROCESS_ID) REFERENCES TDT_qua_trinh_dao_tao(id) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE TDT_lich_su_giang_day (
	...
	CONSTRAINT FK_lich_su_giang_day_giang_vien FOREIGN KEY (giang_vien_id) REFERENCES TDT_LECTURER(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_lich_su_giang_day_hoc_ky FOREIGN KEY (hoc_ky) REFERENCES TDT_SEMESTER(SEMESTER) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_lich_su_giang_day_mon_hoc FOREIGN KEY (ma_mon) REFERENCES TDT_SUBJECT(SUBJECT_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
