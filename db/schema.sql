...
CREATE TABLE TDT_SATISFACTORY_SCORE (
	...
	CONSTRAINT FK_SATISFACTORY_SCORE_LECTURER FOREIGN KEY (LECTURER_ID) REFERENCES TDT_giang_vien(id) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_SATISFACTORY_SCORE_SUBJECT_ID FOREIGN KEY (SUBJECT_ID) REFERENCES TDT_mon_hoc(ma_mon) ON DELETE RESTRICT ON UPDATE RESTRICT,
