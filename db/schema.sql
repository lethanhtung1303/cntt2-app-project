...
CREATE TABLE TDT_TRAINING_PROCESS (
	...
	CONSTRAINT FK_TRAINING_PROCESS_LECTURER FOREIGN KEY (LECTURER_ID) REFERENCES TDT_giang_vien(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_TRAINING_PROCESS_QUALIFICATION FOREIGN KEY (QUALIFICATION_ID) REFERENCES TDT_trinh_do(id) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE TDT_ngon_ngu_dao_tao (
    ...
    CONSTRAINT FK_ngon_ngu_dao_tao_qua_trinh_dao_tao FOREIGN KEY (qua_trinh_dao_tao_id) REFERENCES TDT_TRAINING_PROCESS(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE TDT_TEACHING_HISTORY (
	...
	CONSTRAINT FK_TEACHING_HISTORY_LECTURER FOREIGN KEY (LECTURER_ID) REFERENCES TDT_giang_vien(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_TEACHING_HISTORY_SEMESTER FOREIGN KEY (SEMESTER_ID) REFERENCES TDT_hoc_ky(hoc_ky) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_TEACHING_HISTORY_SUBJECT FOREIGN KEY (SUBJECT_ID) REFERENCES TDT_mon_hoc(ma_mon) ON DELETE RESTRICT ON UPDATE RESTRICT,
