...
INSERT INTO TDT_loai_giang_vien (ma_loai,phan_loai,CREATED_AT,CREATED_BY) VALUES
	 (0,'Giảng viên thỉnh giảng',CURRENT_TIMESTAMP,'sys_user'),
	 (1,'Giảng viên cơ hữu',CURRENT_TIMESTAMP,'sys_user');
...
CREATE TABLE TDT_nhat_ky_giang_day (
	...
	CONSTRAINT FK_nhat_ky_giang_day_hoc_ky FOREIGN KEY (hoc_ky) REFERENCES TDT_hoc_ky(hoc_ky) ON DELETE RESTRICT ON UPDATE RESTRICT
);
